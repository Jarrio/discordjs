...
@:jsRequire("discord.js", "Collection") extern class Collection<K, V> extends discord_js.collection.Collection<K, V> {
	function new();
	/**
	...
	**/
	function concat(collections:haxe.extern.Rest<discord_js.collection.Collection<K, V>>):Collection<K, V>;
	/**
